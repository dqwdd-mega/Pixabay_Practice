...
interface PixabayRepository {
     ...
     * @param query 검색 쿼리
     */
    suspend fun searchVideo(key: String, query: String): BaseResult<List<VideoSearch>>
     ...
     */
    suspend fun searchImage(key: String, query: String, imageType: String): BaseResult<List<ImageSearch>>
}