...
import com.pixabay.feat.home.R
...
fun FeaturedVideoSection(
    ...
    onClickVideo: (com.pixabay.core.domain.model.pixabay.VideoSearch) -> Unit = {},
) {
...
fun SearchImageItem(
    modifier: Modifier = Modifier,
    image: com.pixabay.core.domain.model.pixabay.ImageSearch,
    ...
    Box(
        ...
        Image(
            ...
            painter = if (isFavorite) {
                painterResource(id = com.pixabay.core.designsystem.R.drawable.ic_heart)
            } else {
                painterResource(id = com.pixabay.core.designsystem.R.drawable.ic_heart_empty)
            },
